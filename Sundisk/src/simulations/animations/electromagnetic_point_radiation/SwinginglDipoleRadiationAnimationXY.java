 ...
 */
public class SwinginglDipoleRadiationAnimationXY {
	static double resScale = 2.;  
	  static int width = (int)(320*resScale);
	  static int height = (int)(240*resScale);
	  static int streamlen = 80;
	  static String fname = "C:\\Development\\Projects\\SundquistDLIC_2014\\DLICs\\SwingingDipole_10_XY\\s";
	  static int frames = 121;
	  static double scale = 1.0;
	  static int widthct= 12;
	  ...
	  public static void main(String[] args){  
		...
		//	double Timetotal = (widthct/2.)/(1.-(Nframesdelay*1.+Nframesafter*1.)/(frames*1.-1.));
		    ...
		    renderer.SetXdir(new Vec3(1,0.,0));
		   // renderer.SetYdir(new Vec3(0.,0.,-1.));  this is the negative z axis
		    renderer.SetYdir(new Vec3(0,-1.,0));    // this is the positive y axis
