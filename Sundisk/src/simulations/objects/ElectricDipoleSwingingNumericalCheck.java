 ...
 * @version 1.0 
 */
public class ElectricDipoleSwingingNumericalCheck extends BaseObject {
  ...
  public ElectricDipoleSwingingNumericalCheck(Vec3 x, double p0, double omega, double theta, double Tdelay)
  {
	  this.x = x;
	  this.p0 = p0;
      this.omega = omega;
  ...
  public Vec3 Efield(Vec3 x, Vec3 E)
  {
   ...
   // System.out.println("output from dipole.EfieldNumericalCheck x.x = " + x.x  + " x.z = "+ x.z);
